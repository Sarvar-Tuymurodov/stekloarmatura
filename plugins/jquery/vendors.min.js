...
!function (e, t) {
    ...
    w.fn = w.prototype = {
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || h(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (e = arguments[s])) for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (w.isPlainObject(r) || (o = Array.isArray(r))) ? (n = a[t], i = o && !Array.isArray(n) ? [] : o || w.isPlainObject(n) ? n : {}, o = !1, a[t] = w.extend(l, i, r)) : void 0 !== r && (a[t] = r));
        return a
    }, w.extend({
        expando: "jQuery" + (x + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var r, o, a = 0, s = [];
            if (k(e)) for (r = e.length; a < r; a++) null != (o = t(e[a], a, n)) && s.push(o); else for (a in e) null != (o = t(e[a], a, n)) && s.push(o);
            return i(s)
        }, guid: 1, support: d
    ...
    var S = function (e) {
        var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, v, y, m, b, x = "sizzle" + 1 * new Date, w = e.document, k = 0,
            S = 0, C = ue(), T = ue(), E = ue(), L = ue(), j = function (e, t) {
                return e === t && (f = !0), 0
            }, N = {}.hasOwnProperty, O = [], A = O.pop, D = O.push, P = O.push, R = O.slice, q = function (e, t) {
            ...
            I = "\\[" + F + "*(" + M + ")(?:" + F + "*([*^$|!~]?=)" + F + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + M + "))|)" + F + "*\\]",
            B = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + I + ")*)|.*)\\)|)",
            W = new RegExp(F + "+", "g"), U = new RegExp("^" + F + "+|((?:^|[^\\\\])(?:\\\\.)*)" + F + "+$", "g"),
            $ = new RegExp("^" + F + "*," + F + "*"), V = new RegExp("^" + F + "*([>+~]|" + F + ")" + F + "*"),
            _ = new RegExp(F + "|>"), z = new RegExp(B), X = new RegExp("^" + M + "$"), K = {
                ID: new RegExp("^#(" + M + ")"),
                CLASS: new RegExp("^\\.(" + M + ")"),
                TAG: new RegExp("^(" + M + "|[*])"),
                ATTR: new RegExp("^" + I),
            ...
            }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, Q = /^[^{]+\{\s*\[native \w/,
            Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
        ...
        try {
            P.apply(O = R.call(w.childNodes), w.childNodes), O[w.childNodes.length].nodeType
        } catch (t) {
            P = {
        ...
        function se(e, t, r, o) {
            ...
            if (!o && (p(t), t = t || d, g)) {
                ...
                if (n.qsa && !L[e + " "] && (!v || !v.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (y = e, m = t, 1 === w && (_.test(e) || V.test(e))) {
                        for ((m = ee.test(e) && ye(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(re, oe) : t.setAttribute("id", c = x)), s = (h = a(e)).length; s--;) h[s] = (c ? "#" + c : ":scope") + " " + be(h[s]);
                        y = h.join(",")
                    }
                    try {
        ...
        for (t in n = se.support = {}, i = se.isXML = function (e) {
            ...
            }, y = [], v = [], (n.qsa = Q.test(d.querySelectorAll)) && (ce((function (e) {
                var t;
                h.appendChild(e).innerHTML = "<a id='" + x + "'></a><select id='" + x + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && v.push("[*^$]=" + F + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || v.push("\\[" + F + "*(?:value|" + H + ")"), e.querySelectorAll("[id~=" + x + "-]").length || v.push("~="), (t = d.createElement("input")).setAttribute("name", ""), e.appendChild(t), e.querySelectorAll("[name='']").length || v.push("\\[" + F + "*name" + F + "*=" + F + "*(?:''|\"\")"), e.querySelectorAll(":checked").length || v.push(":checked"), e.querySelectorAll("a#" + x + "+*").length || v.push(".#.+[+~]"), e.querySelectorAll("\\\f"), v.push("[\\r\\n\\f]")
            })), ce((function (e) {
            ...
            }))), (n.matchesSelector = Q.test(m = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector)) && ce((function (e) {
            ...
            if (p(e), n.matchesSelector && g && !L[t + " "] && (!y || !y.test(t)) && (!v || !v.test(t))) try {
                var r = m.call(e, t);
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === o ? function (e) {
                        ...
                        var l, c, f, p, d, h, g = i !== a ? "nextSibling" : "previousSibling", v = t.parentNode,
                            y = s && t.nodeName.toLowerCase(), m = !u && !s, b = !1;
                        if (v) {
                            if (i) {
                                for (; g;) {
                            ...
                            if (h = [a ? v.firstChild : v.lastChild], a && m) {
                                for (b = (d = (l = (c = (f = (p = v)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === k && l[1]) && l[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop();) if (1 === p.nodeType && ++b && p === t) {
                                    c[e] = [k, d, b];
                                    break
                                }
                            } else if (m && (b = d = (l = (c = (f = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === k && l[1]), !1 === b) for (; (p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++b || (m && ((c = (f = p[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [k, b]), p !== t));) ;
        ...
        function xe(e, t, n) {
            var r = t.dir, o = t.next, i = o || r, a = n && "parentNode" === i, s = S++;
            return t.first ? function (t, n, o) {
                ...
                if (u) {
                    ...
                    if ((l = c[i]) && l[0] === k && l[1] === s) return p[2] = l[2];
        ...
        function Se(e, t, n, r, o, i) {
            return r && !r[x] && (r = Se(r)), o && !o[x] && (o = Se(o, i)), le((function (i, a, s, u) {
                var l, c, f, p = [], d = [], h = a.length, g = i || function (e, t, n) {
                        for (var r = 0, o = t.length; r < o; r++) se(e, t[r], n);
                        return n
                    }(t || "*", s.nodeType ? [s] : s, []), v = !e || !i && t ? g : ke(g, p, e, s, u),
                    y = n ? o || (i ? e : h || r) ? [] : a : v;
                if (n && n(v, y, s, u), r) for (l = ke(y, d), r(l, [], s, u), c = l.length; c--;) (f = l[c]) && (y[d[c]] = !(v[d[c]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
                ...
                } else y = ke(y === a ? y.splice(h, y.length) : y), o ? o(null, a, y, u) : P.apply(a, y)
            }))
        }
        ...
        function Ce(e) {
            for (var t, n, o, i = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], u = a ? 1 : 0, c = xe((function (e) {
                ...
                if ((n = r.filter[e[u].type].apply(null, e[u].matches))[x]) {
                    ...
                    return Se(1 < u && we(p), 1 < u && be(e.slice(0, u - 1).concat({value: " " === e[u - 2].type ? "*" : ""})).replace(U, "$1"), n, u < o && Ce(e.slice(u, o)), o < i && Ce(e = e.slice(o)), o < i && be(e))
                }
                p.push(n)
            }
            return we(p)
        ...
        return me.prototype = r.filters = r.pseudos, r.setFilters = new me, a = se.tokenize = function (e, t) {
            var n, o, i, a, s, u, l, c = T[e + " "];
            if (c) return t ? 0 : c.slice(0);
            for (s = e, u = [], l = r.preFilter; s;) {
                for (a in n && !(o = $.exec(s)) || (o && (s = s.slice(o[0].length) || s), u.push(i = [])), n = !1, (o = V.exec(s)) && (n = o.shift(), i.push({
                    value: n,
                    type: o[0].replace(U, " ")
                }), s = s.slice(n.length)), r.filter) !(o = K[a].exec(s)) || l[a] && !(o = l[a](o)) || (n = o.shift(), i.push({
                    value: n,
                    type: a,
                    matches: o
                }), s = s.slice(n.length));
            ...
            var n, o, i, s, u, c, f = [], h = [], v = E[e + " "];
            if (!v) {
                for (t || (t = a(e)), n = t.length; n--;) (v = Ce(t[n]))[x] ? f.push(v) : h.push(v);
                (v = E(e, (o = h, s = 0 < (i = f).length, u = 0 < o.length, c = function (e, t, n, a, c) {
                    var f, h, v, y = 0, m = "0", b = e && [], x = [], w = l, S = e || u && r.find.TAG("*", c),
                        C = k += null == w ? 1 : Math.random() || .1, T = S.length;
                    for (c && (l = t == d || t || c); m !== T && null != (f = S[m]); m++) {
                        if (u && f) {
                            for (h = 0, t || f.ownerDocument == d || (p(f), n = !g); v = o[h++];) if (v(f, t || d, n)) {
                                a.push(f);
                                break
                            }
                            c && (k = C)
                    ...
                    if (y += m, s && m !== y) {
                        ...
                        if (e) {
                            if (0 < y) for (; m--;) b[m] || x[m] || (x[m] = A.call(a));
                            x = ke(x)
                        }
                        P.apply(a, x), c && !e && 0 < x.length && 1 < y + i.length && se.uniqueSort(a)
                    }
                    return c && (k = C, l = w), b
                }, s ? le(c) : c))).selector = e
            }
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (i = K.needsContext.test(e) ? 0 : u.length; i-- && (l = u[i], !r.relative[c = l.type]);) if ((f = r.find[c]) && (o = f(l.matches[0].replace(te, ne), ee.test(u[0].type) && ye(t.parentNode) || t))) {
    ...
    (w.fn.init = function (e, t, n) {
        ...
        if (n = n || O, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), j.test(r[1]) && w.isPlainObject(t)) for (r in t) h(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
    ...
    w.fn.extend({
        has: function (e) {
            ...
            if (!E.test(e)) for (; r < o; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? -1 < a.index(n) : 1 === n.nodeType && w.find.matchesSelector(n, e))) {
                i.push(n);
                break
            }
        ...
        w.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = w.filter(r, o)), 1 < this.length && (P[e] || w.uniqueSort(o), D.test(e) && o.reverse()), this.pushStack(o)
        }
    }));
    var q = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function (e) {
        ...
        Deferred: function (t) {
                ...
                r = "pending", o = {
                    state: function () {
                            ...
                            return function () {
                                var s = this, u = arguments, l = function () {
                                    ...
                                    if (!(t < i)) {
                                        ...
                                        l = e && ("object" == typeof e || "function" == typeof e) && e.then, h(l) ? o ? l.call(e, a(i, n, H, o), a(i, n, F, o)) : (i++, l.call(e, a(i, n, H, o), a(i, n, F, o), a(i, n, H, n.notifyWith))) : (r !== H && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                    }
                                }, c = o ? l : function () {
                                    try {
                                        l()
                                    } catch (e) {
                                        w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), i <= t + 1 && (r !== F && (s = void 0, u = [e]), n.rejectWith(s, u))
                                    }
                                };
                        ...
                        return w.Deferred((function (e) {
                            n[0][3].add(a(0, e, h(o) ? o : H, e.notifyWith)), n[1][3].add(a(0, e, h(t) ? t : H)), n[2][3].add(a(0, e, h(r) ? r : F))
                        })).promise()
                    }, promise: function (e) {
            ...
            if (t <= 1 && (M(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(i[n] && i[n].then))) return a.then();
    ...
    }), w.ready.then = B.then, "complete" === v.readyState || "loading" !== v.readyState && !v.documentElement.doScroll ? e.setTimeout(w.ready) : (v.addEventListener("DOMContentLoaded", W), e.addEventListener("load", W));
    var U = function (e, t, n, r, o, i, a) {
        var s = 0, u = e.length, l = null == n;
        if ("object" === b(n)) for (s in o = !0, n) U(e, t, s, n[s], !0, i, a); else if (void 0 !== r && (o = !0, h(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) {
            return l.call(w(e), n)
    ...
    function z(e) {
        return e.replace($, "ms-").replace(V, _)
    }
    ...
    var G = new K, J = new K, Y = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Q = /[A-Z]/g;
    ...
    w.extend({
        ...
        data: function (e, t) {
            ...
            return "object" == typeof e ? this.each((function () {
                ...
                var n;
                if (i && void 0 === t) return void 0 !== (n = J.get(i, e)) || void 0 !== (n = Z(i, e)) ? n : void 0;
                this.each((function () {
                    J.set(this, e, t)
                }))
    ...
    var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, te = new RegExp("^(?:([+-])=|)(" + ee + ")([a-z%]*)$", "i"),
        ne = ["Top", "Right", "Bottom", "Left"], re = v.documentElement, oe = function (e) {
    ...
    function be(e, t, n, r, o) {
        for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === b(i)) w.merge(p, i.nodeType ? [i] : i); else if (me.test(i)) {
        ...
        for (f.textContent = "", d = 0; i = p[d++];) if (r && -1 < w.inArray(i, r)) o && o.push(i); else if (l = oe(i), a = ve(f.appendChild(i), "script"), l && ye(a), n) for (c = 0; i = a[c++];) he.test(i.type || "") && n.push(i);
        return f
    }
    ...
    w.event = {
        global: {}, add: function (e, t, n, r, o) {
            ...
            }), l = (t = (t || "").match(q) || [""]).length; l--;) d = g = (s = ke.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = w.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = w.event.special[d] || {}, c = w.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(q) || [""]).length; l--;) if (d = g = (s = ke.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
            ...
            var t, n, r, o, i, a, s = new Array(arguments.length), u = w.event.fix(e),
                l = (G.get(this, "events") || Object.create(null))[u.type] || [], c = w.event.special[u.type] || {};
            ...
            load: {noBubble: !0}, click: {
                setup: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && L(t, "input") && Le(t, "click", Se), !1
                }, trigger: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && L(t, "input") && Le(t, "click"), !0
                }, _default: function (e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && L(t, "input") && G.get(t, "click") || L(t, "a")
                }
            }, beforeunload: {
    ...
    var je = /<script|<style|<link/i, Ne = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Oe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Re(e, t) {
        var n, r, o, i, a, s;
        if (1 === t.nodeType) {
            if (G.hasData(e) && (s = G.get(e).events)) for (o in G.remove(t, "handle events"), s) for (n = 0, r = s[o].length; n < r; n++) w.event.add(t, o, s[o][n]);
    ...
    function qe(e, t, n, r) {
        t = i(t);
        var o, a, s, u, l, c, f = 0, p = e.length, g = p - 1, v = t[0], y = h(v);
        if (y || 1 < p && "string" == typeof v && !d.checkClone && Ne.test(v)) return e.each((function (o) {
            var i = e.eq(o);
            y && (t[0] = v.call(this, o, i.html())), qe(i, t, n, r)
        }));
        if (p && (a = (o = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (u = (s = w.map(ve(o, "script"), De)).length; f < p; f++) l = o, f !== g && (l = w.clone(l, !0, !0), u && w.merge(s, ve(l, "script"))), n.call(e[f], l, f);
            if (u) for (c = s[s.length - 1].ownerDocument, w.map(s, Pe), f = 0; f < u; f++) l = s[f], he.test(l.type || "") && !G.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : m(l.textContent.replace(Oe, ""), l, c))
        }
        return e
    }
    ...
    w.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = ve(c), r = 0, o = (i = ve(e)).length; r < o; r++) s = i[r], "input" === (l = (u = a[r]).nodeName.toLowerCase()) && pe.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
            if (t) if (n) for (i = i || ve(e), a = a || ve(c), r = 0, o = i.length; r < o; r++) Re(i[r], a[r]); else Re(e, c);
            return 0 < (a = ve(c, "script")).length && ye(a, !f && ve(e, "script")), c
        }, cleanData: function (e) {
            for (var t, n, r, o = w.event.special, i = 0; void 0 !== (n = e[i]); i++) if (X(n)) {
                if (t = n[G.expando]) {
    ...
    var Fe = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Me = function (t) {
    ...
    function We(e, t, n) {
        ...
        return (n = n || Me(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)), !d.pixelBoxStyles() && Fe.test(a) && Be.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
    }
    ...
    var $e = ["Webkit", "Moz", "ms"], Ve = v.createElement("div").style, _e = {};

    function ze(e) {
        return w.cssProps[e] || _e[e] || (e in Ve ? e : _e[e] = function (e) {
            for (var t = e[0].toUpperCase() + e.slice(1), n = $e.length; n--;) if ((e = $e[n] + t) in Ve) return e
        }(e) || e)
    }

    var Xe = /^(none|table(?!-c[ea]).+)/, Ke = /^--/,
    ...
    function Ze(e, t, n) {
        var r = Me(e), o = (!d.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, r), i = o,
            a = We(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
        if (Fe.test(a)) {
            if (!n) return a;
            a = "auto"
        }
        return (!d.boxSizingReliable() && o || !d.reliableTrDimensions() && L(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === w.css(e, "display", !1, r)) && e.getClientRects().length && (o = "border-box" === w.css(e, "boxSizing", !1, r), (i = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + Qe(e, t, n || (o ? "border" : "content"), i, r, a) + "px"
    }
    ...
    w.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, i, a, s = z(t), u = Ke.test(t), l = e.style;
        ...
        css: function (e, t, n, r) {
            var o, i, a, s = z(t);
            return Ke.test(t) || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = We(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
        }
    }), w.each(["height", "width"], (function (e, t) {
        w.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Xe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, r) : Ie(e, Ge, (function () {
                    return Ze(e, t, r)
                }))
            }, set: function (e, n, r) {
                var o, i = Me(e), a = !d.scrollboxSize() && "absolute" === i.position,
                    s = (a || r) && "border-box" === w.css(e, "boxSizing", !1, i), u = r ? Qe(e, t, r, s, i) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - Qe(e, t, "border", !1, i) - .5)), u && (o = te.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ye(0, n, u)
            }
        }
        ...
        css: function (e, t) {
            return U(this, (function (e, t, n) {
                var r, o, i = {}, a = 0;
                if (Array.isArray(t)) {
                    for (r = Me(e), o = t.length; a < o; a++) i[t[a]] = w.css(e, t[a], !1, r);
                    return i
                }
    ...
    function ft(e, t, n) {
        var r, o, i = 0, a = ft.prefilters.length, s = w.Deferred().always((function () {
            delete u.elem
        })), u = function () {
            if (o) return !1;
        ...
        for (function (e, t) {
            var n, r, o, i, a;
            for (n in e) if (o = t[r = z(n)], i = e[n], Array.isArray(i) && (o = i[1], i = e[n] = i[0]), n !== r && (e[r] = i, delete e[n]), (a = w.cssHooks[r]) && "expand" in a) for (n in i = a.expand(i), delete e[r], i) n in e || (e[n] = i[n], t[n] = o); else t[r] = o
        }(c, l.opts.specialEasing); i < a; i++) if (r = ft.prefilters[i].call(l, e, c, l.opts)) return h(r.stop) && (w._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
    ...
    w.Animation = w.extend(ft, {
        tweeners: {
            ...
            var r, o, i, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
                g = e.nodeType && ae(e), v = G.get(e, "fxshow");
            ...
            if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = G.get(e, "display")), "none" === (c = w.css(e, "display")) && (l ? c = l : (le([e], !0), l = e.style.display || l, c = w.css(e, "display"), le([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === w.css(e, "float") && (u || (p.done((function () {
                h.display = l
            })), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            }))), u = !1, d) u || (v ? "hidden" in v && (g = v.hidden) : v = G.access(e, "fxshow", {display: l}), i && (v.hidden = !g), g && le([e], !0), p.done((function () {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each((function () {
                var t = !0, o = null != e && e + "queueHooks", i = w.timers, a = G.get(this);
                if (o) a[o] && a[o].stop && r(a[o]); else for (o in a) a[o] && a[o].stop && at.test(o) && r(a[o]);
                for (o = i.length; o--;) i[o].elem !== this || null != e && i[o].queue !== e || (i[o].anim.stop(n), t = !1, i.splice(o, 1));
                !t && n || w.dequeue(this, e)
            }))
        }, finish: function (e) {
            return !1 !== e && (e = e || "fx"), this.each((function () {
                var t, n = G.get(this), r = n[e + "queue"], o = n[e + "queueHooks"], i = w.timers, a = r ? r.length : 0;
    ...
    w.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            type: {
                set: function (e, t) {
                    if (!d.radioValue && "radio" === t && L(e, "input")) {
                        var n = e.value;
    ...
    w.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ((t = mt(e)).length) for (; n = this[u++];) if (o = yt(n), r = 1 === n.nodeType && " " + vt(o) + " ") {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function (n) {
                ...
                var t, o, i, a;
                if (r) for (o = 0, i = w(this), a = mt(e); t = a[o++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = yt(this)) && G.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : G.get(this, "__className__") || ""))
            }))
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, o) {
            var i, a, s, u, l, f, p, d, y = [r || v], m = c.call(t, "type") ? t.type : t,
                b = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(m + w.event.triggered) && (-1 < m.indexOf(".") && (m = (b = m.split(".")).shift(), b.sort()), l = m.indexOf(":") < 0 && "on" + m, (t = t[w.expando] ? t : new w.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[m] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!o && !p.noBubble && !g(r)) {
                ...
                for (i = 0; (a = y[i++]) && !t.isPropagationStopped();) d = a, t.type = 1 < i ? u : p.bindType || m, (f = (G.get(a, "events") || Object.create(null))[t.type] && G.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && X(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = m, o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !X(r) || l && h(r[m]) && !g(r) && ((s = r[l]) && (r[l] = null), w.event.triggered = m, t.isPropagationStopped() && d.addEventListener(m, wt), r[m](), t.isPropagationStopped() && d.removeEventListener(m, wt), w.event.triggered = void 0, s && (r[l] = s)), t.result
            }
    ...
    var kt = e.location, St = {guid: Date.now()}, Ct = /\?/;
    ...
    function Nt(e, t, n, r) {
        ...
        if (Array.isArray(t)) w.each(t, (function (t, o) {
            n || Tt.test(e) ? r(e, o) : Nt(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, r)
        })); else if (n || "object" !== b(t)) r(e, t); else for (o in t) Nt(e + "[" + o + "]", t[o], n, r)
    }
    ...
    w.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map((function () {
                ...
                var e = this.type;
                return this.name && !w(this).is(":disabled") && jt.test(this.nodeName) && !Lt.test(e) && (this.checked || !pe.test(e))
            })).map((function (e, t) {
                var n = w(this).val();
    ...
    var Ot = /%20/g, At = /#.*$/, Dt = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Rt = /^(?:GET|HEAD)$/,
        qt = /^\/\//, Ht = {}, Ft = {}, Mt = "*/".concat("*"), It = v.createElement("a");

    function Bt(e) {
        return function (t, n) {
            "string" != typeof t && (n = t, t = "*");
            var r, o = 0, i = t.toLowerCase().match(q) || [];
    ...
    It.href = kt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, o, i, a, s, u, l, c, f, p, d = w.ajaxSetup({}, n), h = d.context || d,
                g = d.context && (h.nodeType || h.jquery) ? w(h) : w.event, y = w.Deferred(),
                m = w.Callbacks("once memory"), b = d.statusCode || {}, x = {}, k = {}, S = "canceled", C = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        return null == l && (e = k[e.toLowerCase()] = k[e.toLowerCase()] || e, x[e] = t), this
            ...
            if (y.promise(C), d.url = ((t || d.url || kt.href) + "").replace(qt, kt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(q) || [""], null == d.crossDomain) {
                u = v.createElement("a");
                try {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), Wt(Ht, d, n, C), l) return C;
            for (f in (c = w.event && d.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Rt.test(d.type), o = d.url.replace(At, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Ot, "+")) : (p = d.url.slice(o.length), d.data && (d.processData || "string" == typeof d.data) && (o += (Ct.test(o) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (o = o.replace(Dt, "$1"), p = (Ct.test(o) ? "&" : "?") + "_=" + St.guid++ + p), d.url = o + p), d.ifModified && (w.lastModified[o] && C.setRequestHeader("If-Modified-Since", w.lastModified[o]), w.etag[o] && C.setRequestHeader("If-None-Match", w.etag[o])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && C.setRequestHeader("Content-Type", d.contentType), C.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Mt + "; q=0.01" : "") : d.accepts["*"]), d.headers) C.setRequestHeader(f, d.headers[f]);
            if (d.beforeSend && (!1 === d.beforeSend.call(h, C, d) || l)) return C.abort();
            if (S = "abort", m.add(d.complete), C.done(d.success), C.fail(d.error), r = Wt(Ft, d, n, C)) {
            ...
            function T(t, n, a, u) {
                var f, p, v, x, k, S = n;
                l || (l = !0, s && e.clearTimeout(s), r = void 0, i = u || "", C.readyState = 0 < t ? 4 : 0, f = 200 <= t && t < 300 || 304 === t, a && (x = function (e, t, n) {
                ...
                }(d, C, a)), !f && -1 < w.inArray("script", d.dataTypes) && (d.converters["text script"] = function () {
                }), x = function (e, t, n, r) {
                ...
                }(d, x, C, f), f ? (d.ifModified && ((k = C.getResponseHeader("Last-Modified")) && (w.lastModified[o] = k), (k = C.getResponseHeader("etag")) && (w.etag[o] = k)), 204 === t || "HEAD" === d.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = x.state, p = x.data, f = !(v = x.error))) : (v = S, !t && S || (S = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || S) + "", f ? y.resolveWith(h, [p, S, C]) : y.rejectWith(h, [C, S, v]), C.statusCode(b), b = void 0, c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [C, d, f ? p : v]), m.fireWith(h, [C, S]), c && (g.trigger("ajaxComplete", [C, d]), --w.active || w.event.trigger("ajaxStop")))
            }
    ...
    var $t = {0: 200, 1223: 204}, Vt = w.ajaxSettings.xhr();
    d.cors = !!Vt && "withCredentials" in Vt, d.ajax = Vt = !!Vt, w.ajaxTransport((function (t) {
        var n, r;
    ...
    w.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Xt, "$1" + o) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            return a || w.error(o + " was not called"), a[0]
        }, t.dataTypes[0] = "json", i = e[o], e[o] = function () {
            a = arguments
        }, r.always((function () {
            void 0 === i ? w(e).removeProp(o) : e[o] = i, t[o] && (t.jsonpCallback = n.jsonpCallback, zt.push(o)), a && h(i) && i(a[0]), a = i = void 0
        })), "script"
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((r = (t = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href, t.head.appendChild(r)) : t = v), i = !n && [], (o = j.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, i), i && i.length && w(i).remove(), w.merge([], o.childNodes)));
        var r, o, i
        ...
        w.cssHooks[t] = Ue(d.pixelPosition, (function (e, n) {
            if (n) return n = We(e, t), Fe.test(n) ? w(e).position()[t] + "px" : n
        }))
    ...
    }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = L, w.isFunction = h, w.isWindow = g, w.camelCase = z, w.type = b, w.now = Date.now, w.isNumeric = function (e) {
        var t = w.type(e);
    ...
    function n(e) {
        for (var n = 1; n < arguments.length; n++) {
            var r = null != arguments[n] ? Object(arguments[n]) : {}, o = Object.keys(r);
    ...
    var S = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
        C = function (e) {
            function t(e) {
                ...
                return r(this, t), n = s(this, u(t).call(this)), S && d.call(a(n)), n.data = e || {}, n.options = o, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n
            }
            ...
            return c(t, d), i(t, [{
                ...
                key: "addResource", value: function (e, t, n, r) {
                    ...
                    void 0 === i && (i = ".");
                    var a = [e, t];
                    n && (a = a.concat(i ? n.split(i) : n)), e.indexOf(".") > -1 && (r = t, t = (a = e.split("."))[1]), this.addNamespaces(t), y(this.data, a, r), o.silent || this.emit("added", e, t, n, r)
                }
            }, {
                ...
                key: "addResourceBundle", value: function (e, t, r, o, i) {
                    var a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {silent: !1}, s = [e, t];
                    e.indexOf(".") > -1 && (o = r, r = t, t = (s = e.split("."))[1]), this.addNamespaces(t);
                    var u = m(this.data, s) || {};
                    o ? function e(t, n, r) {
                        for (var o in n) "__proto__" !== o && (o in t ? "string" == typeof t[o] || t[o] instanceof String || "string" == typeof n[o] || n[o] instanceof String ? r && (t[o] = n[o]) : e(t[o], n[o], r) : t[o] = n[o]);
                        return t
                    }(u, r, i) : u = n({}, u, r), y(this.data, s, u), a.silent || this.emit("added", e, t, r)
                }
            }, {
            ...
            function o(e) {
                var t, n, i, l, c = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                return r(this, o), t = s(this, u(o).call(this)), S && d.call(a(t)), n = ["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], i = e, l = a(t), n.forEach((function (e) {
                    i[e] && (l[e] = i[e])
                })), t.options = c, void 0 === t.options.keySeparator && (t.options.keySeparator = "."), t.logger = p.create("translator"), t
            }
            ...
            return c(o, d), i(o, [{
                ...
                key: "translate", value: function (t, r, o) {
                    var i = this;
                    ...
                    var a = void 0 !== r.keySeparator ? r.keySeparator : this.options.keySeparator,
                        s = this.extractFromKey(t[t.length - 1], r), u = s.key, l = s.namespaces, c = l[l.length - 1],
                        f = r.lng || this.language, p = r.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
                    ...
                    var h = this.resolve(t, r), g = h && h.res, v = h && h.usedKey || u, y = h && h.exactUsedKey || u,
                        m = Object.prototype.toString.apply(g),
                        b = void 0 !== r.joinArrays ? r.joinArrays : this.options.joinArrays,
                        x = !this.i18nFormat || this.i18nFormat.handleAsObject;
                    if (x && g && "string" != typeof g && "boolean" != typeof g && "number" != typeof g && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(m) < 0 && ("string" != typeof b || "[object Array]" !== m)) {
                        if (!r.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(v, g, r) : "key '".concat(u, " (").concat(this.language, ")' returned an object instead of string.");
                        if (a) {
                            var w = "[object Array]" === m, k = w ? [] : {}, S = w ? y : v;
                            for (var C in g) if (Object.prototype.hasOwnProperty.call(g, C)) {
                                var T = "".concat(S).concat(a).concat(C);
                                k[C] = this.translate(T, n({}, r, {joinArrays: !1, ns: l})), k[C] === T && (k[C] = g[C])
                            }
                            g = k
                        }
                    } else if (x && "string" == typeof b && "[object Array]" === m) (g = g.join(b)) && (g = this.extendTranslation(g, t, r, o)); else {
                        var E = !1, L = !1;
                        if (!this.isValidLookup(g) && void 0 !== r.defaultValue) {
                            if (E = !0, void 0 !== r.count) {
                                var j = this.pluralResolver.getSuffix(f, r.count);
                                g = r["defaultValue".concat(j)]
                            }
                            g || (g = r.defaultValue)
                        }
                        this.isValidLookup(g) || (L = !0, g = u);
                        var N = r.defaultValue && r.defaultValue !== g && this.options.updateMissing;
                        if (L || E || N) {
                            if (this.logger.log(N ? "updateKey" : "missingKey", f, c, u, N ? r.defaultValue : g), a) {
                                var O = this.resolve(u, n({}, r, {keySeparator: !1}));
                            ...
                            var A = [],
                                D = this.languageUtils.getFallbackCodes(this.options.fallbackLng, r.lng || this.language);
                            if ("fallback" === this.options.saveMissingTo && D && D[0]) for (var P = 0; P < D.length; P++) A.push(D[P]); else "all" === this.options.saveMissingTo ? A = this.languageUtils.toResolveHierarchy(r.lng || this.language) : A.push(r.lng || this.language);
                            var R = function (e, t) {
                                i.options.missingKeyHandler ? i.options.missingKeyHandler(e, c, t, N ? r.defaultValue : g, N, r) : i.backendConnector && i.backendConnector.saveMissing && i.backendConnector.saveMissing(e, c, t, N ? r.defaultValue : g, N, r), i.emit("missingKey", e, c, t, g)
                            };
                            if (this.options.saveMissing) {
                                var q = void 0 !== r.count && "string" != typeof r.count;
                                this.options.saveMissingPlurals && q ? A.forEach((function (e) {
                                    i.pluralResolver.getPluralFormsOfKey(e, u).forEach((function (t) {
                                        return R([e], t)
                                    }))
                                })) : R(A, u)
                            }
                        }
                        g = this.extendTranslation(g, t, r, h, o), L && g === u && this.options.appendNamespaceToMissingKey && (g = "".concat(c, ":").concat(u)), L && this.options.parseMissingKeyHandler && (g = this.options.parseMissingKeyHandler(g))
                    }
                    return g
                }
            }, {
                key: "extendTranslation", value: function (e, t, r, o, i) {
                    var a = this;
                    if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, r, o.usedLng, o.usedNS, o.usedKey, {resolved: o}); else if (!r.skipInterpolation) {
                        r.interpolation && this.interpolator.init(n({}, r, {interpolation: n({}, this.options.interpolation, r.interpolation)}));
                        var s,
                            u = r.interpolation && r.interpolation.skipOnVariables || this.options.interpolation.skipOnVariables;
                        if (u) {
                            var l = e.match(this.interpolator.nestingRegexp);
                            s = l && l.length
                        }
                        var c = r.replace && "string" != typeof r.replace ? r.replace : r;
                        if (this.options.interpolation.defaultVariables && (c = n({}, this.options.interpolation.defaultVariables, c)), e = this.interpolator.interpolate(e, c, r.lng || this.language, r), u) {
                        ...
                        !1 !== r.nest && (e = this.interpolator.nest(e, (function () {
                            ...
                            return i && i[0] === n[0] ? (a.logger.warn("It seems you are nesting recursively key: ".concat(n[0], " in key: ").concat(t[0])), null) : a.translate.apply(a, n.concat([t]))
                        }), r)), r.interpolation && this.interpolator.reset()
                    }
                    var p = r.postProcess || this.options.postProcess, d = "string" == typeof p ? [p] : p;
                    return null != e && d && d.length && !1 !== r.applyPostProcessor && (e = T.handle(d, e, t, this.options && this.options.postProcessPassResolved ? n({i18nResolved: o}, r) : r, this)), e
                }
            }, {
                    ...
                    return "string" == typeof e && (e = [e]), e.forEach((function (e) {
                        if (!a.isValidLookup(t)) {
                            ...
                            c.forEach((function (e) {
                                a.isValidLookup(t) || (i = e, !E["".concat(d[0], "-").concat(e)] && a.utils && a.utils.hasLoadedNamespace && !a.utils.hasLoadedNamespace(i) && (E["".concat(d[0], "-").concat(e)] = !0, a.logger.warn('key "'.concat(n, '" for languages "').concat(d.join(", "), '" won\'t get resolved as namespace "').concat(i, '" was not yet loaded'), "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), d.forEach((function (n) {
                                    if (!a.isValidLookup(t)) {
                                        o = n;
                                        var i, u, c = l, d = [c];
                                        for (a.i18nFormat && a.i18nFormat.addLookupKeys ? a.i18nFormat.addLookupKeys(d, l, n, e, s) : (f && (i = a.pluralResolver.getSuffix(n, s.count)), f && p && d.push(c + i), p && d.push(c += "".concat(a.options.contextSeparator).concat(s.context)), f && d.push(c += i)); u = d.pop();) a.isValidLookup(t) || (r = u, t = a.getResource(n, e, u, s))
                                    }
                                })))
                            }))
                        }
    ...
    var N = function () {
        function e(t) {
            r(this, e), this.options = t, this.whitelist = this.options.supportedLngs || !1, this.supportedLngs = this.options.supportedLngs || !1, this.logger = p.create("languageUtils")
        }
        ...
        function e(t) {
            var n, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            r(this, e), this.languageUtils = t, this.options = o, this.logger = p.create("pluralResolver"), this.rules = (n = {}, O.forEach((function (e) {
                e.lngs.forEach((function (t) {
                    n[t] = {numbers: e.nr, plurals: A[e.fc]}
                }))
            })), n)
        }
        ...
        function e() {
            ...
            r(this, e), this.logger = p.create("interpolator"), this.options = t, this.format = t.interpolation && t.interpolation.format || function (e) {
                return e
            }, this.init(t)
        }
        ...
        return i(e, [{
            ...
            key: "interpolate", value: function (e, t, n, r) {
                ...
                return [{
                    ...
                    for (a = 0; o = t.regex.exec(e);) {
                        if (void 0 === (i = c(o[1].trim()))) if ("function" == typeof f) {
                            var n = f(e, o, r);
                            i = "string" == typeof n ? n : ""
                        } else {
                            if (p) {
            ...
            key: "nest", value: function (e, t) {
                var r, o, i = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                    s = n({}, a);

                function u(e, t) {
                    var r = this.nestingOptionsSeparator;
                    if (e.indexOf(r) < 0) return e;
                    var o = e.split(new RegExp("".concat(r, "[ ]*{"))), i = "{".concat(o[1]);
                ...
                for (s.applyPostProcessor = !1, delete s.defaultValue; r = this.nestingRegexp.exec(e);) {
                    ...
                    if ((o = t(u.call(this, r[1].trim(), s), s)) && r[0] === e && "string" != typeof o) return o;
                    "string" != typeof o && (o = g(o)), o || (this.logger.warn("missed to resolve ".concat(r[1], " for nesting ").concat(e)), o = ""), c && (o = l.reduce((function (e, t) {
        ...
        function t(e, n, o) {
            var i, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
            return r(this, t), i = s(this, u(t).call(this)), S && d.call(a(i)), i.backend = e, i.store = n, i.services = o, i.languageUtils = o.languageUtils, i.options = l, i.logger = p.create("backendConnector"), i.state = {}, i.queue = [], i.backend && i.backend.init && i.backend.init(o, l.backend, l), i
        }
        ...
        return c(t, d), i(t, [{
            ...
            key: "loaded", value: function (e, t, n) {
                ...
                this.queue.forEach((function (n) {
                    var r, s, u, l, c;
                    r = n.loaded, s = i, (l = (u = v(r, [o], Object)).obj)[c = u.k] = l[c] || [], l[c].push(s), function (e, t) {
    ...
    return new (function (t) {
        function o() {
            ...
            if (r(this, o), e = s(this, u(o).call(this)), S && d.call(a(e)), e.options = q(t), e.services = {}, e.logger = p, e.modules = {external: []}, n && !e.isInitialized && !t.isClone) {
        ...
        return c(o, d), i(o, [{
            key: "init", value: function () {
                ...
                if ("function" == typeof r && (o = r, r = {}), r.whitelist && !r.supportedLngs && this.logger.deprecate("whitelist", 'option "whitelist" will be renamed to "supportedLngs" in the next major - please make sure to rename this option asap.'), r.nonExplicitWhitelist && !r.nonExplicitSupportedLngs && this.logger.deprecate("whitelist", 'options "nonExplicitWhitelist" will be renamed to "nonExplicitSupportedLngs" in the next major - please make sure to rename this option asap.'), this.options = n({}, {
                ...
                }, this.options, q(r)), this.format = this.options.interpolation.format, o || (o = H), !this.options.isClone) {
                    ...
                    var s = this.services;
                    s.logger = p, s.resourceStore = this.store, s.languageUtils = a, s.pluralResolver = new D(a, {
                        prepend: this.options.pluralSeparator,
                        compatibilityJSON: this.options.compatibilityJSON,
                        simplifyPluralSuffix: this.options.simplifyPluralSuffix
                    }), s.interpolator = new P(this.options), s.utils = {hasLoadedNamespace: this.hasLoadedNamespace.bind(this)}, s.backendConnector = new R(i(this.modules.backend), s.resourceStore, s, this.options), s.backendConnector.on("*", (function (e) {
                ...
                var u = h(), l = function () {
                    t.changeLanguage(t.options.lng, (function (e, n) {
                        t.isInitialized = !0, t.options.isClone || t.logger.log("initialized", t.options), t.emit("initialized", t.options), u.resolve(n), o(e, n)
                    }))
                };
            ...
            key: "loadResources", value: function (e) {
                var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : H,
                ...
                if ("function" == typeof e && (n = e), !this.options.resources || this.options.partialBundledLanguages) {
                    ...
                    r ? i(r) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach((function (e) {
                        return i(e)
            ...
            key: "getFixedT", value: function (t, r) {
                var o = this, i = function t(r, i) {
                    var a;
                    if ("object" !== e(i)) {
                        for (var s = arguments.length, u = new Array(s > 2 ? s - 2 : 0), l = 2; l < s; l++) u[l - 2] = arguments[l];
                        a = o.options.overloadTranslationOptionHandler([r, i].concat(u))
                    } else a = n({}, i);
                    return a.lng = a.lng || t.lng, a.lngs = a.lngs || t.lngs, a.ns = a.ns || t.ns, o.t(r, a)
                };
                return "string" == typeof t ? i.lng = t : i.lngs = t, i.ns = r, i
            }
        }, {
            ...
            key: "cloneInstance", value: function () {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    i = n({}, this.options, t, {isClone: !0}), a = new o(i);
                return ["store", "services", "language"].forEach((function (t) {
                    a[t] = e[t]
                })), a.services = n({}, this.services), a.services.utils = {hasLoadedNamespace: a.hasLoadedNamespace.bind(a)}, a.translator = new L(a.services, a.options), a.translator.on("*", (function (e) {
                    for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++) n[r - 1] = arguments[r];
    ...
    function a(e) {
        return (a = "function" == typeof Symbol && "symbol" === i(Symbol.iterator) ? function (e) {
            return i(e)
        } : function (e) {
    ...
    function u(e, t, n, r, o) {
        r && "object" === a(r) && (o || (r._t = new Date), r = s("", r).slice(1)), t.queryStringParams && (e = s(e, t.queryStringParams));
        try {
            var i;
    ...
    var c = function () {
        ...
        return n = t, (r = [{
            key: "init", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                this.services = e, this.options = o(t, this.options || {}, l())
            }
        }, {
    ...
    var i = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, a = function (e, t, n) {
        ...
        name: "cookie", lookup: function (e) {
            ...
            t.lookupCookie && "undefined" != typeof document && function (e, t, n, r) {
                ...
                n && (o.expires = new Date, o.expires.setTime(o.expires.getTime() + 60 * n * 1e3)), r && (o.domain = r), document.cookie = a(e, encodeURIComponent(t), o)
        ...
        return n = t, (r = [{
            key: "init", value: function (e) {
                ...
                }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(s), this.addDetector(u), this.addDetector(f), this.addDetector(h), this.addDetector(g), this.addDetector(v), this.addDetector(y), this.addDetector(m)
            }
        }, {
        ...
        init: function (n, r) {
            function o(t, r, o) {
                ...
                if (0 !== r.length) {
                    ...
                    if (0 === r.indexOf("[")) {
                        var u = r.split("]");
                        r = u[1], a = u[0].substr(1, u[0].length - 1)
                    }
                    if (r.indexOf(";") === r.length - 1 && (r = r.substr(0, r.length - 2)), "html" === a) t.html(n.t(r, i(o, t.html()))); else if ("text" === a) t.text(n.t(r, i(o, t.text()))); else if ("prepend" === a) t.prepend(n.t(r, i(o, t.html()))); else if ("append" === a) t.append(n.t(r, i(o, t.html()))); else if (0 === a.indexOf("data-")) {
                        var l = a.substr("data-".length), c = n.t(r, i(o, t.data(l)));
                        t.data(l, c), t.attr(a, c)
                    } else t.attr(a, n.t(r, i(o, t.attr(a))))
                }
            }

            function i(t, n) {
                var i = t.attr(s.selectorAttr);
                if (i || void 0 === i || !1 === i || (i = t.text() || t.val()), i) {
                    var a = t, u = t.data(s.targetAttr);
                    if (u && (a = t.find(u) || t), n || !0 !== s.useOptionsAttr || (n = t.data(s.optionsAttr)), n = n || {}, i.indexOf(";") >= 0) {
                        var l = i.split(";");
                    ...
                    if (!0 === s.useOptionsAttr) {
                        var c = {};
                        delete (c = e({clone: c}, n)).lng, t.data(s.optionsAttr, c)
                    }
                }
            }
            ...
            function a(e) {
                return this.each((function () {
                    i(r(this), e), r(this).find("[" + s.selectorAttr + "]").each((function () {
                        i(r(this), e)
                    }))
                }))
            }
            ...
            s = e({}, t, s), r[s.tName] = n.t.bind(n), r[s.i18nName] = n, r.fn[s.handleName] = a
        }
    }
}));